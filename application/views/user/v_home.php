                          ...
                          <?php
                            foreach ($data_booking as $row_booking) {
                              ...
                              if($row->id_ruang == $row_booking->id_ruang && $row_booking->hari == 'sunday'){ ?>       
                                <center><span class="<?php echo $label; ?>"><div class="NameHighlights"><font color="white"><?php echo "($row_booking->waktu)<br/>($row_booking->status)"; ?></font><div><font color="black"> PIC : <?php echo $row_booking->nama; ?><br>Hari/Tanngal : <?php echo "$row_booking->hari, $row_booking->tgl"; ?><br>Jam : <?php echo $row_booking->waktu; ?><br>Topik : <?php echo $row_booking->topik; ?> </font></div></div></span><br></center>
                              <?php }else{
                                echo "";
                              }
                            }  
