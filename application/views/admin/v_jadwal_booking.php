                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <?php if ($sts == 'Upcoming') { ?>
                              ...
                              <a class="btn btn-xs btn-primary" href="<?php echo base_url() . 'admin/jadwal_booking/reschedule/' . $hist->id_booking;?>">Reschedule</a>
                            <?php } else { ?>
  ...
  <script type="text/javascript">
    ...
    function cancelBooking(id_booking){
       var r=confirm("Do you want to cancel booking ?")
        if (r==true)
          window.location = url+"admin/jadwal_booking/cancel_booking/"+id_booking;
        else
          return false;
        } 
  </script>
