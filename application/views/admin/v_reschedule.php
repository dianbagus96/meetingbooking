  ...
  <div class="layout-content-body">
    <div class="title-bar">
      <h1 class="title-bar-title">
        <span class="d-ib">Reschedule</span>
      </h1>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  echo form_open('admin/jadwal_booking/reschedule',$atributes);
                  ...
                  ?>
                        ...
                        <label class="col-sm-3 control-label" for="form-control-1">Tanggal</label>
                          <div class="col-sm-6">
                            <div class="input-with-icon">
                              <input class="form-control" type="text" value="<?php echo $dt->tgl; ?>" name="tanggal" data-provide="datepicker" data-date-autoclose="true" required>
                    ...
                    <?php endforeach; ?>
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <a href="<?php echo base_url() . 'admin/jadwal_booking'; ?>" class="btn btn-default btn-block">Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
